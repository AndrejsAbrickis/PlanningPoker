...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__aspnet_signalr__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__EventBus__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__HubEvents__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Login_vue__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__PokerTable_vue__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_vue_class_component__ = __webpack_require__(1);
...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.mounted = function () {
        this.pokerHub = new __WEBPACK_IMPORTED_MODULE_0__aspnet_signalr__["HubConnection"](HUBS.POKER);
        this.pokerHub.start();
        this.pokerHub.on(__WEBPACK_IMPORTED_MODULE_2__HubEvents__["a" /* default */].Connected, this.handleConnected);
        this.pokerHub.on(__WEBPACK_IMPORTED_MODULE_2__HubEvents__["a" /* default */].Disconnected, this.handleDisconnected);
        this.pokerHub.on(__WEBPACK_IMPORTED_MODULE_2__HubEvents__["a" /* default */].UpdateUser, this.handleUpdateUser);
        this.pokerHub.on(__WEBPACK_IMPORTED_MODULE_2__HubEvents__["a" /* default */].Send, this.handleSend);
        this.pokerHub.on(__WEBPACK_IMPORTED_MODULE_2__HubEvents__["a" /* default */].UsersJoined, this.handleUserJoined);
        this.pokerHub.on(__WEBPACK_IMPORTED_MODULE_2__HubEvents__["a" /* default */].NewGame, this.handleNewGame);
        this.pokerHub.on(__WEBPACK_IMPORTED_MODULE_2__HubEvents__["a" /* default */].ShowCards, this.handleShowCards);
        this.pokerHub.on(__WEBPACK_IMPORTED_MODULE_2__HubEvents__["a" /* default */].JoinGroup, this.handleJoinGroup);
        this.pokerHub.on(__WEBPACK_IMPORTED_MODULE_2__HubEvents__["a" /* default */].LeaveGroup, this.handleLeaveGroup);
    };
    App.prototype.handleConnected = function (usersOnline) {
        var _this = this;
        usersOnline.forEach(function (user) {
            _this.$set(_this.playersOnline, user.connectionId, {
                Name: user.name || ""
            });
        });
    };
    App.prototype.handleDisconnected = function (usersOnline) {
        var _this = this;
        this.playersOnline = {};
        usersOnline.forEach(function (user) {
            _this.$set(_this.playersOnline, user.connectionId, {
    ...
    App.prototype.join = function (playerName) {
        this.pokerHub.invoke(__WEBPACK_IMPORTED_MODULE_2__HubEvents__["a" /* default */].JoinUser, playerName);
    };
    App.prototype.playCard = function (card) {
        this.pokerHub.invoke(__WEBPACK_IMPORTED_MODULE_2__HubEvents__["a" /* default */].Send, card);
    };
    App.prototype.handleUserJoined = function (user) {
        this.joined = true;
        this.$set(this.playersOnline, user.connectionId, { Name: user.name });
    };
    App.prototype.handleSend = function (message) {
        this.messages.push(message);
        // this.message = "";
    };
    App.prototype.newGame = function () {
        this.pokerHub.invoke(__WEBPACK_IMPORTED_MODULE_2__HubEvents__["a" /* default */].NewGame);
    };
    ...
    App.prototype.showCards = function () {
        this.pokerHub.invoke(__WEBPACK_IMPORTED_MODULE_2__HubEvents__["a" /* default */].ShowCards);
    };
    App.prototype.handleShowCards = function () {
        this.isCardsRevealed = true;
    };
    App.prototype.joinGroup = function (playerName, groupId) {
        var message = { playerName: playerName, groupId: groupId };
        this.pokerHub.invoke(__WEBPACK_IMPORTED_MODULE_2__HubEvents__["a" /* default */].JoinGroup, message);
        if (history.pushState) {
            var url = window.location.protocol + "//" + window.location.host + window.location.pathname + "?groupId=" + groupId;
            window.history.pushState({ path: url }, "", url);
        }
    };
    App.prototype.handleJoinGroup = function (usersOnline) {
        var _this = this;
        this.playersOnline = {};
        usersOnline.forEach(function (user) {
            _this.$set(_this.playersOnline, user.connectionId, {
    ...
    App.prototype.handleLeaveGroup = function () {
        console.warn(__WEBPACK_IMPORTED_MODULE_2__HubEvents__["a" /* default */].LeaveGroup);
    };
    App.prototype.handleUpdateUser = function (user) {
        this.joined = true;
        this.player = user;
    };
    App = __decorate([
        __WEBPACK_IMPORTED_MODULE_6_vue_class_component___default()({
            components: {
                Login: __WEBPACK_IMPORTED_MODULE_3__Login_vue__["a" /* default */],
                PokerTable: __WEBPACK_IMPORTED_MODULE_4__PokerTable_vue__["a" /* default */]
            }
        })
    ], App);
    return App;
}(__WEBPACK_IMPORTED_MODULE_5_vue___default.a));
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return EventBus; });
...
var Login = /** @class */ (function (_super) {
    ...
    function Login() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.groupId = _this.player.groupId || "";
        _this.valid = false;
        _this.playerName = "";
        return _this;
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_class_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_class_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vue_class_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__PlayersOnline_vue__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__CardsDeck_vue__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__GamesStats_vue__ = __webpack_require__(35);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var PokerTable = /** @class */ (function (_super) {
    ...
    PokerTable = __decorate([
        __WEBPACK_IMPORTED_MODULE_1_vue_class_component___default()({
            components: {
                PlayersOnline: __WEBPACK_IMPORTED_MODULE_2__PlayersOnline_vue__["a" /* default */],
                CardsDeck: __WEBPACK_IMPORTED_MODULE_3__CardsDeck_vue__["a" /* default */],
                GamesStats: __WEBPACK_IMPORTED_MODULE_4__GamesStats_vue__["a" /* default */]
            },
            props: {
                player: Object,
                messages: Array,
...
/* harmony default export */ __webpack_exports__["a"] = (PokerTable);
...
var PlayersOnline = /** @class */ (function (_super) {
    __extends(PlayersOnline, _super);
    function PlayersOnline() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Object.defineProperty(PlayersOnline.prototype, "playersOnline", {
        get: function () {
            var _this = this;
            return Object.keys(this.players)
                .filter(function (playerKey) { return playerKey != _this.user.connectionId; })
                .map(function (playerKey) { return _this.players[playerKey]; });
        },
        enumerable: true,
        configurable: true
    });
    PlayersOnline = __decorate([
        __WEBPACK_IMPORTED_MODULE_1_vue_class_component___default()({
            props: {
                players: Object,
                user: Object
...
/* harmony default export */ __webpack_exports__["a"] = (PlayersOnline);
...
var GamesStats = /** @class */ (function (_super) {
    __extends(GamesStats, _super);
    function GamesStats() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.cards = CARDS;
    ...
    GamesStats.prototype.mounted = function () {
        __WEBPACK_IMPORTED_MODULE_2__EventBus__["b" /* default */].$on(__WEBPACK_IMPORTED_MODULE_2__EventBus__["a" /* Events */].NEW_GAME_STARTED, this.newGame);
    };
    GamesStats.prototype.vote = function (card) {
        this.hasVoted = true;
        this.playCard(card);
    };
    GamesStats.prototype.newGame = function () {
        this.hasVoted = false;
    };
    GamesStats = __decorate([
        __WEBPACK_IMPORTED_MODULE_1_vue_class_component___default()({
            props: {
                playCard: Function
            }
...
/* harmony default export */ __webpack_exports__["a"] = (GamesStats);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuetify__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_472cff63_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(40);
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_472cff63_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_472cff63_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["b" /* staticRenderFns */],
...
var update = add("2d6ad170", content, false, {});
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return HUB_EVENTS; });
var HUB_EVENTS = {
    Send: "Send",
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Login_vue__ = __webpack_require__(9);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_a20123aa_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Login_vue__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
/* script */
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_a20123aa_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Login_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_a20123aa_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Login_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-a20123aa", Component.options)
  } else {
    hotAPI.reload("data-v-a20123aa", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
                          ...
                          _c("v-text-field", {
                            attrs: {
                              ...
                              rules: [
                                function() {
                                  return (
                                    !!_vm.playerName || "This field is required"
                                  )
                                }
                              ]
                            },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-a20123aa", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_lib_selector_type_script_index_0_PokerTable_vue__ = __webpack_require__(10);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_c85095fa_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PokerTable_vue__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-c85095fa"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null

var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_lib_selector_type_script_index_0_PokerTable_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_c85095fa_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PokerTable_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_c85095fa_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PokerTable_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "PokerTable.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c85095fa", Component.options)
  } else {
    hotAPI.reload("data-v-c85095fa", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
// add the styles to the DOM
var add = __webpack_require__(4).default
var update = add("0d019e21", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"id\":\"data-v-c85095fa\",\"scoped\":true,\"sourceMap\":false}!../node_modules/sass-loader/lib/loader.js!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./PokerTable.vue", function() {
     var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"id\":\"data-v-c85095fa\",\"scoped\":true,\"sourceMap\":false}!../node_modules/sass-loader/lib/loader.js!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./PokerTable.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_lib_selector_type_script_index_0_PlayersOnline_vue__ = __webpack_require__(11);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_540a0d67_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PlayersOnline_vue__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-540a0d67"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null

var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_lib_selector_type_script_index_0_PlayersOnline_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_540a0d67_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PlayersOnline_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_540a0d67_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PlayersOnline_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-540a0d67", Component.options)
  } else {
    hotAPI.reload("data-v-540a0d67", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
// add the styles to the DOM
var add = __webpack_require__(4).default
var update = add("0c30b21f", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"id\":\"data-v-540a0d67\",\"scoped\":true,\"sourceMap\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./PlayersOnline.vue", function() {
     var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"id\":\"data-v-540a0d67\",\"scoped\":true,\"sourceMap\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./PlayersOnline.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("h4", [
        _vm._v("Online (" + _vm._s(Object.keys(_vm.players).length) + ")")
      ]),
      _vm._v(" "),
      _c(
        "div",
        [
          _c(
            ...
            [
              _c("v-avatar", { staticClass: "orange" }, [
                _vm._v(_vm._s(_vm.user.name.charAt(0)))
              ]),
      ...
      _vm._v(" "),
      _vm._l(_vm.playersOnline, function(player, key) {
        return _c(
          "div",
          { key: key },
          [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-540a0d67", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_lib_selector_type_script_index_0_CardsDeck_vue__ = __webpack_require__(12);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2b22aeee_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_CardsDeck_vue__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
/* script */
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_lib_selector_type_script_index_0_CardsDeck_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2b22aeee_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_CardsDeck_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2b22aeee_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_CardsDeck_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "CardsDeck.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2b22aeee", Component.options)
  } else {
    hotAPI.reload("data-v-2b22aeee", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2b22aeee", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_lib_selector_type_script_index_0_GamesStats_vue__ = __webpack_require__(13);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_c2f490e8_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_GamesStats_vue__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_lib_selector_type_script_index_0_GamesStats_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_c2f490e8_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_GamesStats_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_c2f490e8_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_GamesStats_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
// add the styles to the DOM
var add = __webpack_require__(4).default
var update = add("0e60cade", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"scoped\":false,\"sourceMap\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./GamesStats.vue", function() {
     var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"optionsId\":\"0\",\"vue\":true,\"scoped\":false,\"sourceMap\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./GamesStats.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-c2f490e8", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-c85095fa", { render: render, staticRenderFns: staticRenderFns })
  }
}
